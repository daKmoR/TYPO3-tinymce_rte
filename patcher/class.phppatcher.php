...
#
# Added JSMin compression of output (Peter Klein)
#
...
define('_PHPP_FAILED_VERIFY', 'Failed source verification of file %s at line %d <br />(Most likely the file have already been patched)');
...
class	PhpPatcher {
	...
	function ApplyPatch() {
		...
		foreach($files as $file) {
			...
			if ( strpos($file, '.html') OR strpos($file, '.htm') OR strpos($file, '_src') )
