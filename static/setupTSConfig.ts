lib.parseFunc_RTE {
	...
	allowTags =	a, abbr, acronym, address, blockquote, br, caption, cite, code, dd, div, dl, dt, em, embed, h1, h2, h3, h4, h5, h6, hr, iframe, img, li, object, ol, p, param, pre, q, span, strong, sub, sup, table, tbody, td, th, tr, tt, ul
	
	# DO NOT ADD class="bodytext" TO EACH LINE
	nonTypoTagStdWrap.encapsLines.addAttributes.P.class >

	# DO NOT WRAP THOSE TAGS WITH <p>
	nonTypoTagStdWrap.encapsLines.encapsTagList = address, cite, div, dl, hr, h1, h2, h3, h4, h5, h6, iframe, p, pre, table
